  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#121212]">
      <div className="bg-[#1e1e1e] p-8 rounded-lg shadow-lg w-80">
        <h2 className="text-2xl font-bold text-[#e0e0e0] text-center mb-6">Signup</h2>
        <form>
          <div className="mb-4">
          ...
          <div className="mb-4">
            <label htmlFor="username" className="block text-[#b0b0b0] mb-2">Username</label>
            <input
              type="text"
          ...
          <div>
            <div className="mt-2 text-center cursor-pointer underline text-blue-400" onClick={() => navigate('/signin')} >Signin</div>
          </div>
        </form>
      </div>
    </div>)
